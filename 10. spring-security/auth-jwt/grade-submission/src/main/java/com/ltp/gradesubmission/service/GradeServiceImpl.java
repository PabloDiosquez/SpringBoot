...
public class GradeServiceImpl implements GradeService{
    ...
    public Grade saveGrade(Grade grade, Long studentId, Long courseId) {
        ...
        Course unwrappedCourse = CourseServiceImpl.unwrapCourse(courseRepository.findById(courseId), courseId);
        if(!unwrappedStudent.getCourses().contains(unwrappedCourse)) throw new StudentNotEnrolledException(studentId, courseId);
